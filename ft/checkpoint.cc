...
status_init(void) {
    ...
    STATUS_INIT(CP_LONG_BEGIN_THRESHOLD,                nullptr, UINT64,   "long checkpoint begin threshold", TOKU_ENGINE_STATUS);
...
toku_checkpoint(CHECKPOINTER cp, TOKULOGGER logger,
    ...
    STATUS_VALUE(CP_LONG_BEGIN_THRESHOLD) = toku_checkpoint_long_threshold;
