...
fs_status_init(void) {
    ...
    FS_STATUS_INIT(FS_LONG_FSYNC_THRESHOLD,   FILESYSTEM_LONG_FSYNC_THRESHOLD, UINT64,   "long fsync threshold", TOKU_ENGINE_STATUS|TOKU_GLOBAL_STATUS);
...
fs_get_status(DB_ENV * env, fs_redzone_state * redzone_state) {
    ...
    *redzone_state = (fs_redzone_state) FS_STATUS_VALUE(FS_ENOSPC_REDZONE_STATE);
    ...
    FS_STATUS_VALUE(FS_LONG_FSYNC_THRESHOLD) = long_fsync_threshold;
